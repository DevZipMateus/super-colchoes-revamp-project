            ...
            <div className="text-center lg:text-left space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight text-gray-900">
                  <span className="text-5xl text-zinc-950">SuperColchões</span>
                  <br />
                  <span className="text-lg sm:text-xl lg:text-3xl xl:text-4xl text-zinc-950 md:text-4xl">
                    Especialista em Colchões há mais de{' '}
                    <span className="text-zinc-950">20 anos</span>
                  </span>
                </h1>
              </div>

              {/* Promotional Information */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 my-8 sm:my-12 px-2 sm:px-0">
                ...
                <div className="bg-white/95 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg border-2 border-blue-200 sm:col-span-2 lg:col-span-1 xl:col-span-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start px-4 sm:px-0">
                <Button size="lg" onClick={handleWhatsAppClick} className="bg-green-600 hover:bg-green-700 text-white text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 shadow-lg w-full sm:w-auto">
                  Fale no WhatsApp
                </Button>
              </div>
