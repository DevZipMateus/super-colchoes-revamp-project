...
const HeroSection = () => {
  return (
    <section id="inicio" className="bg-gradient-to-br from-green-50 to-green-100 py-16 lg:py-24">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight">
                O Melhor <span className="text-red-600">Colchão</span> para o Seu <span className="text-green-600">Conforto</span>
              </h1>
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
              <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-xl h-80 flex items-center justify-center">
