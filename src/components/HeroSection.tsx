...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen bg-white overflow-hidden w-full">
      ...
      <div className="relative z-10 w-full max-w-full px-4 py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20 2xl:py-24">
              ...
              <div className="text-center lg:text-left space-y-4 sm:space-y-6 md:space-y-8 xl:space-y-10 2xl:space-y-12 order-2 lg:order-1 w-full max-w-full">
                ...
                <div className="w-full my-6 sm:my-8 md:my-10 lg:my-12 xl:my-16">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-2 md:gap-3 lg:gap-3 xl:gap-4 2xl:gap-6 w-full max-w-full">
                    <div className="bg-white/95 backdrop-blur-sm p-3 sm:p-2 md:p-3 lg:p-4 xl:p-5 2xl:p-6 rounded-xl shadow-lg border-2 border-green-200 hover:shadow-xl transition-all duration-300 hover:scale-105 min-h-[100px] sm:min-h-[90px] md:min-h-[100px] lg:min-h-[110px] xl:min-h-[120px] 2xl:min-h-[130px] flex flex-col justify-center items-center text-center w-full">
                      <div className="text-xl sm:text-lg md:text-xl lg:text-2xl xl:text-2xl 2xl:text-3xl font-bold mb-1" style={{color: '#0DA456'}}>12x</div>
                    ...
                    <div className="bg-white/95 backdrop-blur-sm p-3 sm:p-2 md:p-3 lg:p-4 xl:p-5 2xl:p-6 rounded-xl shadow-lg border-2 border-green-200 hover:shadow-xl transition-all duration-300 hover:scale-105 min-h-[100px] sm:min-h-[90px] md:min-h-[100px] lg:min-h-[110px] xl:min-h-[120px] 2xl:min-h-[130px] flex flex-col justify-center items-center text-center w-full">
                      <div className="text-xl sm:text-lg md:text-xl lg:text-2xl xl:text-2xl 2xl:text-3xl font-bold mb-1" style={{color: '#0DA456'}}>20%</div>
                    ...
                    <div className="bg-white/95 backdrop-blur-sm p-3 sm:p-2 md:p-3 lg:p-4 xl:p-5 2xl:p-6 rounded-xl shadow-lg border-2 border-green-200 hover:shadow-xl transition-all duration-300 hover:scale-105 min-h-[100px] sm:min-h-[90px] md:min-h-[100px] lg:min-h-[110px] xl:min-h-[120px] 2xl:min-h-[130px] flex flex-col justify-center items-center text-center w-full">
                      <div className="text-xl sm:text-lg md:text-xl lg:text-2xl xl:text-2xl 2xl:text-3xl font-bold mb-1" style={{color: '#0DA456'}}>15%</div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start w-full max-w-full">
                  <Button 
                    ...
                    className="text-white text-sm sm:text-base md:text-lg xl:text-xl 2xl:text-2xl px-4 sm:px-6 md:px-8 xl:px-10 2xl:px-12 py-3 sm:py-4 md:py-5 xl:py-6 2xl:py-7 shadow-lg w-full sm:w-auto hover:scale-105 transition-all duration-300" 
                  ...
                  <Button 
                    ...
                    className="text-gray-800 text-sm sm:text-base md:text-lg xl:text-xl 2xl:text-2xl px-4 sm:px-6 md:px-8 xl:px-10 2xl:px-12 py-3 sm:py-4 md:py-5 xl:py-6 2xl:py-7 shadow-lg w-full sm:w-auto hover:scale-105 transition-all duration-300" 
              ...
              <div className="flex justify-center lg:justify-end order-1 lg:order-2 w-full max-w-full">
                <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl">
                  <img 
                    ...
                    className="w-full h-auto object-cover rounded-lg shadow-xl hover:scale-105 transition-transform duration-500 max-w-full" 
                  />
                </div>
              </div>
            </div>
