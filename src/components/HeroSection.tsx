        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-theme(spacing.32))] sm:min-h-[calc(100vh-theme(spacing.40))] lg:min-h-[80vh] xl:min-h-[85vh] 2xl:min-h-[90vh]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 2xl:gap-20 items-center w-full">
            ...
            <div className="text-center lg:text-left space-y-4 sm:space-y-6 md:space-y-8 xl:space-y-10 2xl:space-y-12 order-2 lg:order-1">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 xl:p-8 2xl:p-10 shadow-lg space-y-2 sm:space-y-3 xl:space-y-4 mx-2 sm:mx-4 md:mx-0 hover:shadow-xl transition-all duration-300">
                <p className="text-sm sm:text-base md:text-lg xl:text-xl 2xl:text-2xl font-semibold text-gray-800 flex items-center justify-center lg:justify-start">
                  <span className="mr-2 text-lg xl:text-xl 2xl:text-2xl">📍</span>
                  <span className="text-center lg:text-left">Rua Riachuelo, 224 - Esq. Tuiuti, Santa Maria, RS</span>
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-2 sm:gap-4 xl:gap-6 text-xs sm:text-sm md:text-base xl:text-lg 2xl:text-xl text-gray-600">
