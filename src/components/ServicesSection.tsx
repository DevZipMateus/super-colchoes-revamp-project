      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-black mb-6">
            Nossos <span className="text-green-600 opacity-60">Serviços</span>
          </h2>
            ...
            return (
              <Card key={index} className={`hover:shadow-2xl transition-all duration-300 border-2 ${service.borderColor} ${service.bgColor} h-full group`}>
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-xl font-bold text-black leading-tight mb-4">
                    {service.title}
                  </CardTitle>
                </CardHeader>
            ...
            {additionalFeatures.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  <IconComponent className="w-12 h-12 text-green-600 opacity-60 mx-auto mb-4" />
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-green-600 to-green-700 opacity-60 rounded-2xl p-8 text-black shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button 
                ...
                className="bg-green-600 text-black px-8 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors duration-300 flex items-center justify-center gap-2"
              >
