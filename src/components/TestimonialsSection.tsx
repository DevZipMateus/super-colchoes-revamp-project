      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center space-y-4 sm:space-y-6 xl:space-y-8 mb-12 sm:mb-16 xl:mb-20 2xl:mb-24">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-gray-900">
            O que nossos <span className="text-gray-950" style={{
            color: '#000000'
          }}>Clientes</span> dizem
          </h2>
          ...
          <div className="flex items-center justify-center space-x-2 xl:space-x-4 mt-6 xl:mt-8">
            <div className="flex">
              {[...Array(5)].map((_, i) => <Star key={i} className="w-6 h-6 xl:w-8 xl:h-8 2xl:w-10 2xl:h-10 fill-yellow-400 text-yellow-400" />)}
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 xl:gap-10 2xl:gap-12 max-w-6xl xl:max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => <Card key={index} className="hover:shadow-xl transition-all duration-300 border-0 shadow-lg hover:scale-105">
              <CardContent className="p-6 xl:p-8 2xl:p-10 space-y-4 xl:space-y-6">
                <div className="flex items-center justify-between">
                  <div className="flex">
                    {[...Array(testimonial.rating)].map((_, i) => <Star key={i} className="w-4 h-4 xl:w-5 xl:h-5 2xl:w-6 2xl:h-6 fill-yellow-400 text-yellow-400" />)}
                  </div>
                  <Quote className="w-6 h-6 xl:w-8 xl:h-8 2xl:w-10 2xl:h-10" style={{
                color: '#000000'
              }} />
                </div>
                ...
                <div className="border-t pt-4 xl:pt-6">
                  <div className="flex items-center space-x-3 xl:space-x-4">
                    <div className="w-12 h-12 xl:w-14 xl:h-14 2xl:w-16 2xl:h-16 bg-green-100 rounded-full flex items-center justify-center">
                      <span className="font-bold text-lg xl:text-xl 2xl:text-2xl" style={{
                    color: '#000000'
                  }}>
        ...
        <div className="text-center mt-12 xl:mt-16 2xl:mt-20">
          ...
          <div className="rounded-2xl p-8 xl:p-10 2xl:p-12 max-w-2xl xl:max-w-4xl 2xl:max-w-5xl mx-auto bg-[#e0f4ea]">
            <h3 className="text-2xl xl:text-3xl 2xl:text-4xl font-bold mb-4 xl:mb-6 text-gray-950" style={{
            color: '#000000'
          }}>
