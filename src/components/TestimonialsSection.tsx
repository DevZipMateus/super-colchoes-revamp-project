      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900">
            O que nossos <span style={{
            color: '#2cf96a'
          }} className="text-gray-950">Clientes</span> dizem
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => <Card key={index} className="hover:shadow-xl transition-shadow border-0 shadow-lg">
        ...
        <div className="text-center mt-12">
          ...
          <div className="rounded-2xl p-8 max-w-2xl mx-auto bg-[#08ff04]/60">
            <h3 style={{
            color: '#2cf96a'
          }} className="text-2xl font-bold mb-4 text-gray-950">
