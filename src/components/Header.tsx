...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-lg sticky top-0 z-50 w-full max-w-full overflow-x-hidden">
      {/* Top bar - Responsive */}
      <div className="text-white py-2 sm:py-3 hidden sm:block w-full" style={{ backgroundColor: '#3b3f3c' }}>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-3 sm:py-4 lg:py-5 xl:py-6">
        <div className="flex justify-between items-center w-full">
          <div className="flex items-center flex-shrink-0">
            <Link to="/">
              <img 
                ...
                alt="SuperColchões" 
                className="h-8 sm:h-10 md:h-12 lg:h-14 xl:h-16 2xl:h-20 w-auto transition-all duration-300 max-w-full object-contain" 
              />
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-4 xl:space-x-6 2xl:space-x-8 flex-shrink-0">
            ...
            <a href="#produtos" className="text-gray-700 hover:text-green-800 hover:opacity-40 transition-colors font-medium text-sm xl:text-base 2xl:text-lg hover:scale-105 transition-transform whitespace-nowrap">
              Produtos
            </a>
            ...
            <Button 
              className="text-sm xl:text-base 2xl:text-lg px-3 xl:px-4 2xl:px-6 py-2 xl:py-3 flex items-center hover:scale-105 transition-all duration-300 whitespace-nowrap flex-shrink-0" 
        ...
        {isMenuOpen && (
          <nav className="lg:hidden mt-4 pb-4 border-t border-gray-200 w-full">
