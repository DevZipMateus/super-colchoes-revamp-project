  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 xl:py-24 2xl:py-32 bg-white" id="contato">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 xl:gap-16 2xl:gap-20 mb-12 sm:mb-16 xl:mb-20 2xl:mb-24">
        ...
        {/* Mapa do Google Maps - Otimizado */}
        <div className="bg-gray-50 rounded-2xl p-4 sm:p-8 xl:p-10 2xl:p-12">
          <h3 className="text-xl sm:text-2xl xl:text-3xl 2xl:text-4xl font-bold text-center text-gray-900 mb-4 sm:mb-6 xl:mb-8">
            Nossa Localização
          </h3>
          <div className="bg-white rounded-lg overflow-hidden shadow-lg">
            <iframe 
              ...
              width="100%" 
              height="300" 
              className="sm:h-[400px] xl:h-[500px] 2xl:h-[600px]" 
              style={{ border: 0 }} 
              allowFullScreen 
              loading="lazy" 
          ...
          <div className="text-center mt-4 sm:mt-6 xl:mt-8 space-y-2 xl:space-y-3">
            <p className="text-base sm:text-lg xl:text-xl 2xl:text-2xl font-semibold text-gray-800">
