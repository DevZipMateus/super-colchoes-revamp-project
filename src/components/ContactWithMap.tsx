      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900">
            Fale <span style={{
            color: '#2cf96a'
          }} className="text-gray-950">Conosco</span>
          </h2>
          ...
          <Card className="shadow-xl border-0">
            ...
            <CardContent className="space-y-4 sm:space-y-6">
              <div className="space-y-2">
                ...
                <Input placeholder="Seu nome completo" className="border-gray-300" style={{
                borderColor: '#2cf96a',
                focusBorderColor: '#2cf96a'
              }} />
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Mensagem</label>
                <Textarea placeholder="Conte-nos sobre suas necessidades, orçamento, preferências..." rows={4} className="border-gray-300" style={{
                borderColor: '#2cf96a',
                focusBorderColor: '#2cf96a'
              }} />
              </div>
              
              <Button className="w-full text-base sm:text-lg py-3" style={{
