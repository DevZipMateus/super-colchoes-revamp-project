        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-6">
            {contactInfo.map((info, index) => (
              <Card key={index} className={`shadow-lg border-0 hover:shadow-xl transition-shadow cursor-pointer ${info.highlight ? 'bg-green-50 border-green-200' : ''}`} onClick={handleWhatsAppClick}>
              </Card>
            ))}
